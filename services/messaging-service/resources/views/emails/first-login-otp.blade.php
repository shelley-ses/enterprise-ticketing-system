...
<body style="font-family: Arial, sans-serif; background: #f7f7f7; color: #111827; padding: 24px;">
    <div style="max-width: 560px; margin: 0 auto; background: #ffffff; border-radius: 12px; padding: 32px; border: 1px solid #e5e7eb;">
        <h1 style="margin: 0 0 16px; font-size: 24px;">First Login Verification Code</h1>
        <p style="margin: 0 0 16px; line-height: 1.6;">Hello {{ $name }},</p>
        <p style="margin: 0 0 20px; line-height: 1.6;">Use this 6-digit code to verify your account and set your new password:</p>
        ...
        <p style="margin: 0; line-height: 1.6; color: #6b7280;">If you did not log in, you can ignore this email.</p>
    </div>
</body>
</html>
