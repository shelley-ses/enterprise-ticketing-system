...
/**
 * Renders the blocking "change password" modal when the backend
 * flags the session as a first-login.  Must live inside <AuthProvider>.
 */
function AuthGate({ children }) {
  ...
  return (
    <>
      {children}
      {isAuthenticated && isFirstLogin && <ForceChangePasswordModal />}
    </>
  );
}
