      ...
      >
        ...
        <div className="flex-1 min-h-[40vh] max-h-[70vh] bg-gray-950 flex items-center justify-center p-4 overflow-auto">
          {isImg && !imgError ? (
            ...
            <div className="text-center text-gray-400 py-12">
              ...
              <p className="text-xs mt-1">The file may not be accessible. Try downloading it below.</p>
            </div>
          ) : isPdf ? (
            <iframe
              src={absoluteUrl}
        ...
        <div className="px-6 py-4 bg-gray-50 flex justify-end gap-3 border-t border-gray-100">
          <button
            ...
            className="px-6 py-2.5 bg-[#252578] hover:bg-[#1a1a5c] text-white text-xs font-bold rounded-xl transition-all shadow-md shadow-[#252578]/20 flex items-center gap-2 cursor-pointer disabled:opacity-50"
          >
